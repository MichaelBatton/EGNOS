 ...
 */
JNIEXPORT jdoubleArray JNICALL Java_com_ec_egnossdk_uBlox_getLongitudeLatitudeEGNOS
		...
		jdoubleArray jklob_array, jintArray RnDoptions,jdoubleArray sat_data_notUsedArray)
{
	...
	(*env)->ReleaseIntArrayElements(env, jutc_array, (jint *)element_utc, 0);
	...
	(*env)->ReleaseIntArrayElements(env, jklob_array, (jint *)element_klob, 0);
	...
	(*env)->ReleaseIntArrayElements(env, jinit_pos, (jint *)elementinit_pos, 0);
 ...
 */
JNIEXPORT jdoubleArray JNICALL Java_com_ec_egnossdk_uBlox_getLongitudeLatitudeGPS
		...
		jdoubleArray jinit_pos, jdoubleArray jutc_array,jdoubleArray sat_data_notUsedArray)
{
	...
	(*env)->ReleaseIntArrayElements(env, jutc_array, (jint *)element, 0);
